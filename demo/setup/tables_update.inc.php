<?php
	...
	function demo_upgrade0_9_17_000()
	{
		...
		$GLOBALS['phpgw_setup']->oProc->AddColumn('phpgw_demo_table', 'category', array(
			'type' => 'int', 'precision' => '4', 'nullable' => True));
		$GLOBALS['phpgw_setup']->oProc->AddColumn('phpgw_demo_table', 'access', array(
			'type' => 'varchar', 'precision' => '7', 'nullable' => True));
