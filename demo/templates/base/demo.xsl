<!-- $Id: demo.xsl 14728 2016-02-11 22:28:46Z sigurdne $ -->
...
<xsl:template match="values">
	<xsl:variable name="lang_view_place_text">
		<xsl:value-of select="lang_view_place_text"/>
	</xsl:variable>
	<xsl:variable name="lang_edit_place_text">
		<xsl:value-of select="lang_edit_place_text"/>
	</xsl:variable>
	<xsl:variable name="lang_delete_place_text">
	...
	<tr>
		...
		<td align="center">
			...
			<a href="{$link_view}" onMouseover="window.status='{$lang_view_place_text}';return true;" onMouseout="window.status='';return true;">
		...
		<xsl:choose>
			<xsl:when test="link_edit != ''">
				<td align="center">
					...
					<a href="{$link_edit}" onMouseover="window.status='{$lang_edit_place_text}';return true;" onMouseout="window.status='';return true;">
		...
		<xsl:choose>
			<xsl:when test="link_edit != ''">
				<td align="center">
					...
					<a href="{$link_delete}" onMouseover="window.status='{$lang_delete_place_text}';return true;" onMouseout="window.status='';return true;">
