<?php
/*
 * $Id: class.Script.inc.php 13955 2015-09-17 16:45:28Z sigurdne $
 *
...
#LK		}
				...
				$vacation['start_date'] <= time() && time() < $vacation['end_date']+24*3600)	// +24*3600 to include the end_date day
			{
				...
				if ($vacation['start_date'] || $vacation['end_date'])
				{
					$message = str_replace(array('$$start$$','$$end$$'),array(
							date($GLOBALS['phpgw_info']['user']['preferences']['common']['dateformat'],$vacation['start_date']),
							date($GLOBALS['phpgw_info']['user']['preferences']['common']['dateformat'],$vacation['end_date']),
						),$message);
				}
				$newscriptbody .= "] text:\n" . $message . "\n.\n;\n\n";
			}
		...
		if ($this->emailNotification && $this->emailNotification['status'] == 'on') {
			...
			$egw_site_title = $GLOBALS['phpgw_info']['server']['site_title'];
