...
<!-- $Id: abook_form.xsl 14719 2016-02-10 19:45:46Z sigurdne $ -->
...
<xsl:template match="abook_data">
		...
		<tr>
			<td valign="top">
				<a href="javascript:abook_lookup()" onMouseover="window.status='{lang_select_abook_help}';return true;" onMouseout="window.status='';return true;">
