<?php
	 ...
	 * @package property
	 * @subpackage budget
	 * @version $Id: class.uibudget.inc.php 17164 2017-10-18 13:36:13Z sigurdne $
	 */
	/**
	 * Description
	 * @package property
		...
		function index()
		{
			...
			$uicols = array(
				...
				array('hidden' => false, 'key' => 'year', 'label' => lang('year'), 'className' => 'center',
					'sortable' => false),
				array('hidden' => false, 'key' => 'revision', 'label' => lang('revision'), 'className' => 'center',
					'sortable' => false),
				...
				array('hidden' => false, 'key' => 'b_account_name', 'label' => lang('name'),
					'sortable' => false),
				array('hidden' => false, 'key' => 'grouping', 'label' => lang('grouping'), 'className' => 'right',
					'sortable' => true),
...
//                        exit();
		...
		function basis()
		{
			...
			$uicols = array(
				...
				array('hidden' => false, 'key' => 'ecodimb', 'label' => lang('dimb'), 'className' => 'right',
					'sortable' => true),
				array('hidden' => false, 'key' => 'category', 'label' => lang('category'), 'className' => 'right',
					'sortable' => false),
		...
		function obligations()
		{
			...
			$uicols = array(
				array('key' => 'grouping', 'hidden' => true, 'label' => '', 'className' => '',
					'sortable' => false),
				array('key' => 'b_account', 'hidden' => false, 'label' => lang('grouping'), 'className' => 'center',
				...
				array('key' => 'budget_cost_ex', 'hidden' => true, 'label' => '', 'className' => 'right',
					'sortable' => false),
				array('key' => 'budget_cost', 'hidden' => false, 'label' => lang('budget'), 'className' => 'right',
					'sortable' => false),
				...
				array('key' => 'actual_cost', 'hidden' => false, 'label' => lang('paid'), 'className' => 'right',
				...
				array('key' => 'diff_ex', 'hidden' => true, 'label' => '', 'className' => 'right',
					'sortable' => false),
				array('key' => 'diff', 'hidden' => false, 'label' => lang('difference'), 'className' => 'right',
					'sortable' => false),
				array('key' => 'percent', 'hidden' => false, 'label' => lang('percent'), 'className' => 'right',
					'sortable' => false)
			);
