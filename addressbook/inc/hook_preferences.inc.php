<?php
  ...
  *  option) any later version.                                              *
  ...
  /* $Id: hook_preferences.inc.php 13898 2015-09-15 09:15:53Z sigurdne $ */
{
// Only Modify the $file and $title variables.....
	$title = $appname;
	$file = Array(
		'Preferences'		=> $GLOBALS['phpgw']->link('/index.php',array('menuaction'=>'addressbook.uiaddressbook_prefs.index')),
