<?php
	...
	*  option) any later version.                                              *
	...
	/* $Id: hook_settings.inc.php 1415 2008-07-10 09:07:24Z sigurd $ */
...
## by tb
	create_check_box('Show complete description in overview','show_descrpt_ovr',
		'Select wether the event description is shown in the overview (e.g. week-view) or not.');
	...
	create_select_box('Show complete description in title-tag','show_descrpt_title',$show_descrpt_title,
		'Select how to show the event description as tooltip: never, ever or as js-tooltip (more infos).');

	create_check_box('Show time-line in detailed weekly view','show_time_line',
