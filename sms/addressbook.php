<?php
	 ...
	 * @package sms
	 * @version $Id: addressbook.php 14728 2016-02-11 22:28:46Z sigurdne $
	 */
...
//_debug_array($entries_comm);
	...
	$lang_showing = lang('%1 - %2 of %3 ', ($d->total_records != 0) ? $start + 1 : $start, $start + $d->total_records, $total_all_persons);
