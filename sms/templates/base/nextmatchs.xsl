<!-- $Id: nextmatchs.xsl 14728 2016-02-11 22:28:46Z sigurdne $ -->
	...
	<table border="0" width="100%">
		<tr>
			<xsl:choose>
				...
				<xsl:otherwise>
					<td width="25">
						<img src="{$img_path}/first-grey.png" border="1" width="12" height="12"/>
					</td>
				</xsl:otherwise>
			</xsl:choose>
			...
			<xsl:choose>
				<xsl:when test="number($all_records) > (number($start_record) + number($record_limit))">
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<td width="25" align="right">
								<img src="{$img_path}/right-grey.png" border="1" width="12" height="12"/>
							</td>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:when>
			...
			<xsl:choose>
				<xsl:when test="number($all_records) > (number($start_record) + number($record_limit))">
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<td width="25" align="right">
								<img src="{$img_path}/last-grey.png" border="1" width="12" height="12"/>
							</td>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:when>
