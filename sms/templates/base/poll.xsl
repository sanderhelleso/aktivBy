<!-- $Id: poll.xsl 14728 2016-02-11 22:28:46Z sigurdne $ -->
...
<xsl:template match="values">
	<xsl:variable name="lang_view_text">
		<xsl:value-of select="lang_view_text"/>
	</xsl:variable>
	...
	<tr>
		...
		<td align="center">
			...
			<a href="{$link_view}" onMouseover="window.status='{$lang_view_text}';return true;" onMouseout="window.status='';return true;">
