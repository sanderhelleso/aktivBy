<?php
	 ...
	 * @package sms
	 * @subpackage sms
	 * @version $Id: class.sms.inc.php 14728 2016-02-11 22:28:46Z sigurdne $
	 */
	/**
	 * Description
	 * @package sms
...
//	_debug_array ($GLOBALS['phpgw_info']['sms_config']);
	...
	if (file_exists("{$apps_path['inc']}/plugin/gateway/{$GLOBALS['phpgw_info']['sms_config']['common']['gateway_module_get']}/get.php") && file_exists("{$apps_path['inc']}/plugin/gateway/{$GLOBALS['phpgw_info']['sms_config']['common']['gateway_module_send']}/send.php"))
	{
